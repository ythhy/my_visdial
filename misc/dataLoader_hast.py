...
class train(data.Dataset):  # torch wrapper
    def __init__(self, input_img_h5, input_ques_h5, input_json, negative_sample, gcst_sample, data_split):
    ...
    def __getitem__(self, index):
        ...
        gcst_opt_ans = np.zeros((self.rnd, 100, self.ans_length))
        ...
        for i in range(self.rnd):
            ...
            for j, ids in enumerate(opt_ids):
                ...
                gcst_opt_ans[i, j, :opt_len] = self.opt_list[ids, :opt_len]
        ...
        return img, his, ques, ans, ans_len, ans_idx2, ques_len, \
               opt_ans, opt_ans_len, opt_ans_idx, gcst_opt_ans
